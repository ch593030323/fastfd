...
public:
    ...
    void of_init(const QString &as_action);

    read_card_type of_read_card(const QString &as_memberno);
    QString of_send_card(const QString &as_memberno);//return errtext
