...
sortItem1::sortItem1(QString kindId,QString name,bool select,QWidget *parent) :
...
void sortItem1::mousePressEvent(QMouseEvent *)
{
    _isSelect = true;
    repaint();
    emit touch(_kindId);
...
void sortItem1::paintEvent(QPaintEvent *)
{
    if(_name.isEmpty())
        return;
    QFont font;
...
void sortItem1::setSelect(bool bo)
{
    _isSelect = bo;
    repaint();
}

void sortItem1::setRect(QRect rect)
{
    _rect = rect;
    repaint();
}

void sortItem1::setName(QString name)
{
    _name = name;
    repaint();
}
