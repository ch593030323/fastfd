...
#ifdef COMMONHEADER
#define COMMONHEADER_COMMON_DLLSPEC  Q_DECL_EXPORT
#else
#define COMMONHEADER_COMMON_DLLSPEC  Q_DECL_IMPORT
#endif
...
class COMMONHEADER_COMMON_DLLSPEC CommonHeader
{
public:
    ...
    //normal_print
    static QStringList creat_normal_printtypes();
    static QStringList creat_normal_printpathtypes();
    static Printer_POS_Virtual *get_variantprinter(const QString &path/*tty,usb,&,:*/, int ttybaudrate);
    //pricecout_scale
    ...
    static Printer_Virtual *getlabelprint_of_type(const QString &printtype);//注意删除该指针
    //barcode scale
    static QStringList creat_barcode_scaletypes();
    static QMap<int, QString> creat_barcode_scale_weigettype(const QString &type);
    static QString creat_barcode_scale_weigettype_init(const QString &type);
...
private:
    ...
    static QMap<int, QString> baudrates;
    static QStandardItemModel label_vidpid_model;

    //barcode scale
    static QStringList barcode_scaletypes;
    static QMap<int, QString> barcode_scale_weigettype;
