...
#ifdef ELECTRONICSCALE_DJIAN
#define ELECTRONICSCALE_DJIAN_COMMON_DLLSPEC  Q_DECL_EXPORT
#else
#define ELECTRONICSCALE_DJIAN_COMMON_DLLSPEC  Q_DECL_IMPORT
#endif
class ELECTRONICSCALE_DJIAN_COMMON_DLLSPEC ElectronicScale_DJIAN
{
public:
