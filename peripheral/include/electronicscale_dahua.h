...
#ifdef ELECTRONICSCALE_DAHUA
#define ELECTRONICSCALE_DAHUA_COMMON_DLLSPEC  Q_DECL_EXPORT
#else
#define ELECTRONICSCALE_DAHUA_COMMON_DLLSPEC  Q_DECL_IMPORT
#endif
class ELECTRONICSCALE_DAHUA_COMMON_DLLSPEC ElectronicScale_DAHUA
{
public:
