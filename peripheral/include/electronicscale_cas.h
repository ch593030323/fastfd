...
#include <QMap>
#ifdef ELECTRONICSCALE_CAS
#define ELECTRONICSCALE_CAS_COMMON_DLLSPEC  Q_DECL_EXPORT
#else
#define ELECTRONICSCALE_CAS_COMMON_DLLSPEC  Q_DECL_IMPORT
#endif
class ELECTRONICSCALE_CAS_COMMON_DLLSPEC ElectronicScale_CAS
{
public:
