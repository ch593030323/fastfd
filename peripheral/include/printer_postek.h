#ifndef PRINTER_POSTEK_H
#define PRINTER_POSTEK_H
//博思得 标签打印机
...
#ifdef PRINTER_POSTEK
#define PRINTER_POSTEK_COMMON_DLLSPEC  Q_DECL_EXPORT
#else
#define PRINTER_POSTEK_COMMON_DLLSPEC  Q_DECL_IMPORT
#endif

class PRINTER_POSTEK_COMMON_DLLSPEC Printer_POSTEK:public Printer_Virtual
{
public:
    enum ROTATE{
        ROTATE_0   = 0,
    ...
    static QMap<QString, QString> oneBarType_of_POSTEK();
    static QMap<QString, QString> twoBarType_of_POSTEK();
    static QMap<QString, QString> textfont_of_POSTEK();
