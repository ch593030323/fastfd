...
#ifdef ELECTRONICSCALE_KAIFENG
#define ELECTRONICSCALE_KAIFENG_COMMON_DLLSPEC  Q_DECL_EXPORT
#else
#define ELECTRONICSCALE_KAIFENG_COMMON_DLLSPEC  Q_DECL_IMPORT
#endif
class  ELECTRONICSCALE_KAIFENG_COMMON_DLLSPEC   ElectronicScale_KAIFENG
{
public:
    ElectronicScale_KAIFENG();
    static QStringList scaleName();
    static QMap<int, QString> WeigetType();
