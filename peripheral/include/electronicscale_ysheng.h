...
#ifdef ELECTRONICSCALE_YSHENG
#define ELECTRONICSCALE_YSHENG_COMMON_DLLSPEC  Q_DECL_EXPORT
#else
#define ELECTRONICSCALE_YSHENG_COMMON_DLLSPEC  Q_DECL_IMPORT
#endif
class ELECTRONICSCALE_YSHENG_COMMON_DLLSPEC ElectronicScale_YSHENG
{
public:
